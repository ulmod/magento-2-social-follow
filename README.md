# Magento 2 Social Follow Buttons Extension

[Magento 2 Social Follow Buttons](https://www.ulmod.com/magento-2-social-follow-buttons.html)  is a Magento 2 extension that allows you to increase the number of followers in each of your social media profiles.

With Magento 2 Social Follow Buttons, you can display floating buttons with external links to your social media profiles, allowing users to follow your social media profiles

<a href="https://www.ulmod.com/magento-2-social-follow-buttons.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Ability to display social follow buttons on any page of your site
* Support up to eight most popular social networks, such as Facebook, Twitter, Pinterest, Instagram, LinkedIn, YouTube, Google+, Flickr
* Ability to display  follow buttons at left, right, and footer of the page
* Configure the social follow buttons from the backend
* Mobile-friendly
* Support multiple-stores

<img src="https://www.ulmod.com/media/ulmod/product_content/umsocialfollow-page.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/umsocialfollow-rwd.png">
